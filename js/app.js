...
(function () {
  ...
  const BM_VER = "20260916-1"; // cache-bust for basemap styles + city/layer data
  ...
  const CURRENCY_SYM = { EUR: "€", USD: "$", GBP: "£", TRY: "₺", JPY: "¥", CZK: "Kč", SGD: "S$", KRW: "₩", AUD: "A$", MXN: "MX$", RUB: "₽", ARS: "AR$", HKD: "HK$" };
